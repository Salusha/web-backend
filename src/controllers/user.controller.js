...
const logoutUser = asyncHandler(async(req, res) => {
    await User.findByIdAndUpdate(
        ...
        {
            $unset: {
                refreshToken: 1 //removes field from document, prev: undefined  
            }
        },
        {
            new: true
...
const updateUserAvatar=asyncHandler(async(req,res)=>{
    ...
    // delete old image - todo, make utility function
...
const getUserChannelProfile=asyncHandler(async(req, res)=>{
    ...
    // User.find({username})  can do this way also but using aggregate pipeline
